...
def seed_users():
    ...
    demo = User(username='Demo', email='demo@aa.io', f_name='Demo',
                password='password', phone_number=1)

    db.session.add(demo)

    demo1 = User(username='Demo1', email='demo1@aa.io', f_name="Demo1", password='password', phone_number=1)

    db.session.add(demo1)

    markZuckerberg = User(username='marky', email='mark@facebook.com', f_name='Mark', password='hotdog',
    ...
    elon = User(username='elon', email='elon@spacex.com', f_name='Elon', password='hotdog',
